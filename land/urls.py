...
urlpatterns = [
    ...
    url(r'^mylands/details/(?P<title_deed>[-\w]+)/$', views.land_details, name='land_details'),
    url(r'^landsonsale/$', views.land_on_sale, name='lands_onsale'),
    url(r'^landsonsale/landdetails/(?P<title_deed>[-\w]+)/$', views.land_details, name='landonsaledetail'),
    url(r'^purchase/(?P<pk>[0-9])/$', views.purchase_land, name='purchase'),
    url(r'^contactus/$', views.contact_us, name='contactus'),
    url(r'^landsbought/$', views.lands_bought, name='lands_bought'),
    ...
    url(r'^landsonsale/search/$', views.search_land_onsale, name='search', ),
